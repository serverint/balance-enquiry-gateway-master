...
import com.wasp.gateway.enquiry.balance.interceptor.CustomHandlerInterceptor
...
class BalanceEnquiryGatewayApplication extends WebMvcConfigurerAdapter{
	...
	static void main(String[] args) {
		SpringApplication.run BalanceEnquiryGatewayApplication, args
	}
}
